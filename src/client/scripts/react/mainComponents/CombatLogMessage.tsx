    ...
    getText(combatLogMessage : ICombatLogMessage) {
        switch(combatLogMessage.type) {
            case ICombatLogMessageType.DAMAGE_DEALT:
                return (<Fragment>
                            <span style={{color: Colors.GREEN}}>You</span> dealt <span style={{color: Colors.YELLOW}}>{
                                //@ts-ignore
                                this.props.combatLogMessage.damage
                            }</span> damage to <span style={{color: Colors.RED}}>{
                                //@ts-ignore
            ...
            case ICombatLogMessageType.DAMAGE_RECEIVED:
                return (<Fragment>
                            ...
                            </span> dealt <span style={{color: Colors.YELLOW}}>{
                                //@ts-ignore
                                this.props.combatLogMessage.damage
                            }</span> damage to <span style={{color: Colors.GREEN}}>you</span>.
                        </Fragment>)
                                      
            case ICombatLogMessageType.MISS_DEALT:
                return (<Fragment>
                        <span style={{color: Colors.GREEN}}>You</span> missed <span style={{color: Colors.RED}}>{
                            //@ts-ignore
                            this.props.combatLogMessage.target
                        }</span>.
                    </Fragment>)
            case ICombatLogMessageType.MISS_RECEIVED:
                    return (<Fragment>
                            <span style={{color: Colors.RED}}>{
                                //@ts-ignore
                                this.props.combatLogMessage.attacker
                            } </span> missed <span style={{color: Colors.GREEN}}>you</span>.
                        </Fragment>)
            case ICombatLogMessageType.ASTROID_MINED:
                return (<Fragment>
                        <span style={{color: Colors.GREEN}}>You</span> mined <span style={{color: Colors.YELLOW}}>{
                            //@ts-ignore
                            this.props.combatLogMessage.amount
                        }</span> m<sup>2</sup> from <span style={{color: Colors.YELLOW}}>{
                            //@ts-ignore
